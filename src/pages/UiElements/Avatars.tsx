...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="Avatars | GNPC Scholarship Portal"
        description="View and use avatar components in the GNPC Scholarship Portal. Explore different avatar sizes and styles."
      />
